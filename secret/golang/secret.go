...
func main() {
	// Jwt Token Credentials (Not Support)
	...
	// Aws String Credentials (Not support yet)
	...
	// Postgresql Connection String Credentials (Not support yet)
	...
	// SECRET: Generic Password Credentials
	// Htpasswd Credentials (Not support yet)
